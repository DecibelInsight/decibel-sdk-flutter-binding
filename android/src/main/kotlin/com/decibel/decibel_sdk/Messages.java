...
public class Messages {
  ...
  public interface DecibelSdkApi {
    ...
    void sendScreenshot(ScreenshotMessage arg);
    ...
    static void setup(BinaryMessenger binaryMessenger, DecibelSdkApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.DecibelSdkApi.sendScreenshot", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              ScreenshotMessage input = ScreenshotMessage.fromMap((Map<String, Object>)message);
              api.sendScreenshot(input);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
