...
#ifndef DECIBELCOREFLUTTERSIGMA_SWIFT_H
#define DECIBELCOREFLUTTERSIGMA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DecibelCoreFlutterSigma",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP23DecibelCoreFlutterSigma15DecibelDelegate_")
...
SWIFT_PROTOCOL("_TtP23DecibelCoreFlutterSigma15DecibelProtocol_")
...
SWIFT_PROTOCOL("_TtP23DecibelCoreFlutterSigma14DecibelFlutter_")
@protocol DecibelFlutter <DecibelProtocol>
/// This method set the screen for a new recorder cycle.
/// \param screen The name of screen.
///
/// \param id Identifier screen.
///
- (void)setWithScreen:(NSString * _Nonnull)screen id:(NSInteger)id;
/// This method set the screen for a new recorder cycle.
...
SWIFT_CLASS("_TtC23DecibelCoreFlutterSigma10DecibelSDK")
@interface DecibelSDK : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) id <DecibelFlutter> _Nonnull flutter;)
+ (id <DecibelFlutter> _Nonnull)flutter SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP23DecibelCoreFlutterSigma11SDKSettings_")
@protocol SDKSettings
...
@interface UIView (SWIFT_EXTENSION(DecibelCoreFlutterSigma))
