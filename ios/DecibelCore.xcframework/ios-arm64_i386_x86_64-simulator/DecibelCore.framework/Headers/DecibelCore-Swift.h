...
@interface Collection (SWIFT_EXTENSION(DecibelCore))
...
@interface Customer (SWIFT_EXTENSION(DecibelCore))
@property (nonatomic, copy) NSString * _Nullable account;
@property (nonatomic) BOOL analyticsConsents;
@property (nonatomic, copy) NSString * _Nullable property;
@property (nonatomic) BOOL sessionReplayConsent;
@end
...
/// Method to mask a UIView.
/// \param view UIView that you want to mask.
///
...
/// Method to unmask a UIView.
/// \param view UIView that you want to unmask.
///
...
SWIFT_CLASS_NAMED("ImageScreen")
@interface ImageScreen : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface ImageScreen (SWIFT_EXTENSION(DecibelCore))
...
@interface Screen (SWIFT_EXTENSION(DecibelCore))
- (void)addCollectionsObject:(Collection * _Nonnull)value;
- (void)removeCollectionsObject:(Collection * _Nonnull)value;
- (void)addCollections:(NSSet * _Nonnull)values;
- (void)removeCollections:(NSSet * _Nonnull)values;
@end
...
@interface Screen (SWIFT_EXTENSION(DecibelCore))
- (void)insertObject:(ImageScreen * _Nonnull)value inImagesAtIndex:(NSInteger)idx;
- (void)removeObjectFromImagesAtIndex:(NSInteger)idx;
- (void)insertImages:(NSArray<ImageScreen *> * _Nonnull)values atIndexes:(NSIndexSet * _Nonnull)indexes;
- (void)removeImagesAtIndexes:(NSIndexSet * _Nonnull)indexes;
- (void)replaceObjectInImagesAtIndex:(NSInteger)idx withObject:(ImageScreen * _Nonnull)value;
- (void)replaceImagesAtIndexes:(NSIndexSet * _Nonnull)indexes withImages:(NSArray<ImageScreen *> * _Nonnull)values;
- (void)addImagesObject:(ImageScreen * _Nonnull)value;
- (void)removeImagesObject:(ImageScreen * _Nonnull)value;
- (void)addImages:(NSOrderedSet * _Nonnull)values;
- (void)removeImages:(NSOrderedSet * _Nonnull)values;
@end
...
@property (nonatomic) int32_t stateInt;
@property (nonatomic, strong) NSSet * _Nullable collections;
@property (nonatomic, strong) NSOrderedSet * _Nullable images;
...
@interface Session (SWIFT_EXTENSION(DecibelCore))
@property (nonatomic, copy) NSString * _Nullable collectionURL;
@property (nonatomic, copy) NSString * _Nullable leadID;
@property (nonatomic, copy) NSString * _Nullable sessionID;
@property (nonatomic, copy) NSDate * _Nullable startDate;
@property (nonatomic) int32_t stateInt;
@property (nonatomic) double videoQuality;
@end
...
@interface Video (SWIFT_EXTENSION(DecibelCore))
@property (nonatomic, copy) NSData * _Nullable videoData;
@end


SWIFT_CLASS("_TtC11DecibelCore19VideoGeneratorError")
